package Koha::Plugin::Fi::KohaSuomi::HidePatronProtected;
...
our $metadata = {
    ...
    maximum_version => '',
    version         => $VERSION,
    description     => 'Hides patron's Protected radio buttons from non-superusers',
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/HidePatronProtected/";
